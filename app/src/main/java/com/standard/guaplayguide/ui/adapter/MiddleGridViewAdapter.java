...
public class MiddleGridViewAdapter extends RecyclerView.Adapter<MiddleGridViewAdapter.ViewHolder> {
    private final String TAG = getClass().getName();
    private List<ModularBean> mModularBeanList;
    private Context mContext;
    private View.OnClickListener mOnModularClickListener;

    public MiddleGridViewAdapter(Context context, List<ModularBean> modularBeanList) {
        mContext = context;
