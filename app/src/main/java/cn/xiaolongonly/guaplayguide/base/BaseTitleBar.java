...
public class BaseTitleBar {
    ...
    private void initTitleBar(View toolView) {
        left = toolView.findViewById(cn.xiaolongonly.guaplayguide.R.id.title_left);
        center = toolView.findViewById(cn.xiaolongonly.guaplayguide.R.id.title_center);
        right = toolView.findViewById(cn.xiaolongonly.guaplayguide.R.id.title_right);
