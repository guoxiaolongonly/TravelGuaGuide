...
public class LargerGridViewAdapter extends RecyclerView.Adapter<LargerGridViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ModularBean data, int position) {
            ...
            {
                UiUtil.setRoundImage(ivModularImage, data.imageUrl,  cn.xiaolongonly.guaplayguide.R.drawable.ic_loading, cn.xiaolongonly.guaplayguide.R.mipmap.ic_load_error,16);
            }
        }
    }
}
