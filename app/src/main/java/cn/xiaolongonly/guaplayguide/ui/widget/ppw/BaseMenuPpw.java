...
//        setBackgroundDrawable(new ColorDrawable(0x55000000));
        setAnimationStyle(cn.xiaolongonly.guaplayguide.R.style.popwin_anim);
    ...
    public void showPopupWindow(View parentView) {
        ...
        if (ppwContentView == null) {
            ppwContentView = LayoutInflater.from(mContext).inflate(cn.xiaolongonly.guaplayguide.R.layout.ppw_base, null);
            ppwContent = ppwContentView.findViewById(cn.xiaolongonly.guaplayguide.R.id.ppwContent);
